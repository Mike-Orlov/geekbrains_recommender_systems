...
class MainRecommender:
    ...
    def fit_als(self, user_item_matrix, n_factors=20, regularization=0.001, iterations=15, num_threads=4, show_progress=True, use_gpu=True):
        """Обучает ALS"""
        ...
        self.model_als.fit(csr_matrix(user_item_matrix).T.tocsr(), show_progress=show_progress)
    ...
    def get_own_recommendations(self, user, N=5):
        ...
        self._update_dict(user_id=user)
        return self._get_recommendations(user, model_als=self.own_recommender, N=N)
