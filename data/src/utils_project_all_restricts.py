...
def prefilter_items(data, take_n_popular=5000, item_features=None, bad_departments=None):
    ...
    Параметры:
    - item_features: убирает категории, где товаров меньше указанного числа
    ...
    data.loc[data['item_id'].isin(items_by_quantity), 'item_id'] = 999998
    ...
    data.loc[data['item_id'].isin(top_3_popular), 'item_id'] = 999997
    ...
    data.loc[data['item_id'].isin(old_items), 'item_id'] = 999996
    ...
    low_price = data.loc[data['price'] < 1, 'item_id'].tolist()
    data.loc[data['item_id'].isin(low_price), 'item_id'] = 999995
